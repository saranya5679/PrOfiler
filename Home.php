...
<head>
  ...
  background-size: cover; /* This property makes the image cover the entire container */
...
<body class="home">
    ...
    <button type="button" class="btn btn-link"><a href="profile.php">Dashboard</a></button>
    ...
    <div class="cont">
<!-- 
 <h1><center><b>WELCOME TO THE HOME PAGE</b></center></h1> -->
